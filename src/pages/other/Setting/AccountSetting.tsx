					...
					<div className="flex mt-2">
						<div className="w-full">
							<div className="bg-white rounded">
								<div className="p-6">
									<div className="grid lg:grid-cols-4 gap-6" data-fc-type="tab">
										<Tab.Group vertical>
											<div className="col-span-1">
												...
												>
													<Tab
														as="button"
														className={({ selected }) =>
															`text-start py-2 px-4 rounded transition-all ${
																selected
														...
														<div className="grid grid-cols-2 items-center gap-6">
															<div>
																...
																<FormInput
																	...
																	className="py-2 px-4 leading-6 block w-full text-gray-700 border-gray-300 rounded text-sm focus:border-gray-300 focus:ring-0"
																	placeholder="Email"
																	defaultValue="greeva@coderthemes.com"
																	containerClass="mb-4"
																/>
															</div>
															<div>

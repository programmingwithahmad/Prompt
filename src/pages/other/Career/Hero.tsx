...
const Hero = () => {
	return (
		<section className="bg-gradient-to-t from-gray-200/70 relative">
			<section id="" className="relative py-16 sm:py-20 md:py-40">
						...
						<div className="order-2 lg:order-1">
							<div className="text-center lg:text-start">
								...
								<p className="text-gray-500 leading-relaxed lg:w-3/4">
									We're always open for new creative, analytical and technical
									minds to join our team. Search for the suitable job.
								</p>
								<div className="mt-10 flex items-center justify-center lg:justify-start">
									<button className="bg-black/70 text-white rounded-md text-sm font-semibold flex-none shadow shadow-black hover:shadow-lg hover:shadow-black/30 focus:shadow-none focus:outline focus:outline-black/50 px-8 py-3">
										View All Openings{' '}

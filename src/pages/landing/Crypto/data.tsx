...
const features: Feature[] = [
	...
	},
	{
		...
		description:
			'Signals with 87% accuracy rate will help you to build a profitable strategy.',
	},
	{
		icon: (
			<svg
		...
		description:
			'We have collected the most useful trading indicators for you. Test them on a demo account to see which ones best suit your trading style.',
	},
	{
		icon: (
			<svg
	...
	},
	{
		...
		description:
			'Various deposit options and fast withdrawal of funds. The minimum deposit is only 10 USD.',
	},
]

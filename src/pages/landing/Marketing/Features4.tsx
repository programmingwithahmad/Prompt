				...
				>
					<div className="order-2 lg:order-1">
						...
						<div>
							<button
								name="Email"
								className="bg-primary text-white rounded-lg text-sm font-semibold flex-none shadow-lg shadow-primary/30 focus:shadow-none focus:outline focus:outline-primary/40  px-8 py-3 mt-8"
							>
								Start Free Trial <i className="fa-solid fa-arrow-right" />
							</button>
						</div>
					</div>
					<div className="order-1 lg:order-2">
						<img src={marketing} alt="marketing4" className="shadow" />
					</div>
				</div>
			</div>
		</section>
